int RPWM_Output_1 = 10;
int LPWM_Output_1 = 11; 
int R_EN_1 = 13;
int L_EN_1 = 12;
...
int stepper_frd_dir_1 = LOW;
int stepper_frd_dir_2 = LOW;

int lin_act_time = 2000;

int forward_pos = 2500;
int backwards_pos = -2500;
int slow_frd_pos = 1250;
int slow_bkrd_pos = -1250;
